...
/*
	raw demuxer, no usable, Jack Lee
*/	
	...
	/* for X86, both muxer and demuxer of MP3, Nov.16th, 2017 */	
	REGISTER_MUXER(MP3,              mp3);

	/* for X86, both muxer and demuxer of image, Nov.16th, 2017 */	
	...
	/* for audio file with aac format and extension, Nov.16th, 2017*/
	REGISTER_DEMUXER (AAC,              aac);
	/* for audio file with mp3 format and extension, Nov.16th, 2017*/
	REGISTER_DEMUXER(MP3,              mp3);

	/* for all image files, Nov.16th, 2017*/
	...
	/* for AAC audio in ARM board. Oct.13,2017 */
