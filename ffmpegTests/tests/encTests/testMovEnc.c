...
static void _init(int bf, int audio_preroll)
{
...
int main(int argc, char **argv)
{
	...
	// Write a similar file, but with B-frames and audio preroll, handled via an edit list.
	...
	format = "mp4";
	// An initial moov that doesn't contain any samples, followed by two moof+mdat pairs.
	init_out("empty-moov");
