...
#define HI_FATAL_PES(fmt...) \
            HI_TRACE(HI_LOG_LEVEL_FATAL, HI_ID_AVPLAY, fmt)

#define HI_ERR_PES(fmt...) \
            HI_TRACE(HI_LOG_LEVEL_ERROR, HI_ID_AVPLAY, fmt)

#define HI_WARN_PES(fmt...) \
            HI_TRACE(HI_LOG_LEVEL_WARNING, HI_ID_AVPLAY, fmt)

#define HI_INFO_PES(fmt...) \
            HI_TRACE(HI_LOG_LEVEL_INFO, HI_ID_AVPLAY, fmt)
#endif
