...
HI_VOID _tsTthread(HI_VOID *args)
{
...
#define VID_FILENAME_PATH  "/mnt/vid.h264"
#define AUD_FILENAME_PATH  "/mnt/aud.aac"
...
HI_VOID* _saveThread(HI_VOID *pArgs)
{
...
HI_S32 main(HI_S32 argc,HI_CHAR *argv[])
{
	...
	pthread_create(&thdSave, HI_NULL,(HI_VOID *)_saveThread,&stSaveArgs);

	pthread_mutex_init(&g_TsMutex,NULL);
	g_bStopTsThread = HI_FALSE;
	pthread_create(&g_TsThd, HI_NULL, (HI_VOID *)_tsTthread, HI_NULL);
