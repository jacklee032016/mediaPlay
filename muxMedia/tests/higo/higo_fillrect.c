/*
* example of draw a rectangle on the graphic layer surface
*/
...
HI_S32 main(HI_S32 argc, HI_CHAR* argv[])
{
	...
	//	ret = HI_GO_FillRect(hSurface,NULL,0xFFFF0000,HIGO_COMPOPT_NONE);
		ret = HI_GO_FillRect(hSurface,NULL,0xFFFF0000, HIGO_COMPOPT_SRCOVER);
		if (HI_SUCCESS != ret)
		{
			goto ERR3;
		}

		ret = HI_GO_SetSurfaceAlpha(hSurface, alpha);
		if (HI_SUCCESS != ret)
		{
