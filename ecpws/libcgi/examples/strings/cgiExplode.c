...
{
	char *desc = CGI_NAME_STR	" examples, explode() function demonstration. <br>"
...
int main()
{
	...
	if (cgi_param("action")) {
		...
		printf(""
		"<html><head><title>"CGI_NAME_STR" examples - explode()</title></head>"
		"<body>"
		"%s<br><br>"
		"<form action='"ROOT_CGI_BIN"cgiExplode."CGI_EXTENSION"' method='post'>"
